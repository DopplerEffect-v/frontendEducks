...
const ModalConfirmacionRegistro = ({
    ...
    /* const confirmacion = () => {
        if (flagSiglas) {
            errors?.siglasIguales ? handleClose() : <h1></h1>
        }
        else {
            methods.clearErrors("siglasIguales");
        }
    } */
            ...
            <div className="d-flex justify-content-center mt-3 ">
                ...
                <div className="px-3">
                    <Button
                        ...
                        endIcon={<CheckIcon />}
                        type="submit"
                    /*  onClick={() => { flagSiglas ? methods.setError("siglasIguales", { message: "Estas siglas ya están registradas" }) : methods.clearErrors("siglasIguales"); }} */
                    >
                        Aceptar
                    </Button>
