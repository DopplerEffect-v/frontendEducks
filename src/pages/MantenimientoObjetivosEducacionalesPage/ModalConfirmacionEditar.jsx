...
const ModalConfirmacionEditar = ({ handleClose, onSubmit }) => {
        ...
        <form>
            ...
            <div className="container w-90  d-flex justify-content-center">
                <div className=" my-4">
                    <h3 style={{ fontWeight: "bold" }}>
                        ¿Desea editar el Objetivo Educacional?
                    </h3>
                </div>
            </div>
            <div className="d-flex justify-content-center mt-3 ">
                ...
                <div className="px-3">
                    ...
                    {errors?.sumilla ? handleClose() : <h1></h1>}
                    {errors?.descripcion ? handleClose() : <h1></h1>}
                    {errors?.comentarios ? handleClose() : <h1></h1>} */}
                </div>
            </div>
        </form>
    );
