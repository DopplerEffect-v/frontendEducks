...
const ModalConfirmacionRegistroPrograma = ({
    handleClose,
    onSubmit
}) => {
        ...
        <form onSubmit={methods.handleSubmit(onSubmit)}>
            ...
            <div className="d-flex justify-content-center mt-3 ">
                ...
                <div className="px-3">
                    ...
                    {errors?.nombre? handleClose():<h1></h1> }
                    {errors?.correoElectronico? handleClose():<h1></h1> }
                    {errors?.responsablePrograma? handleClose():<h1></h1>} */}
                </div>
            </div>
        </form>
    );
...
export default ModalConfirmacionRegistroPrograma;
