...
import NivelesArray from "./NivelEditar";
...
const IndicadorArray = ({ control, methods, indicadorVoid, niveles, numIndicadores, setNumIndicadores, resultado, cont, setCont }) => {
            ...
            {indicadorFields.map((item, index) => {
                return (
                    ...
                    >
                        ...
                        <NivelesArray nestIndex={index} {...{ control, methods, niveles, resultado, cont, setCont }} />
                    </div>
                )
            })}
        </div>
