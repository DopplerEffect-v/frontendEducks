...
const FacultadCoordinador = ({ facultad }) => {
  ...
  return (
    <div className={`container pt-3 h-100 w-100 ${classes.container}`}>
      <Avatar
        ...
        src={facultad ? Perfil_Vacio : Perfil_Vacio}
      />
      ...
      <div className="row align-items-center">
        <div className="col-sm-7 col-md-8 col-lg-9 col-xl-10">
          <input
            ...
            name="coordinadorFacultad"
            disabled
            value={
              methods.getValues("nombreCoordinador") ?
                methods.getValues("nombreCoordinador") : facultad
            ...
            /* required */
          />
          <span> <Typography id="typographyErrorCoord" variant='body2' color='error'>{errors?.coordinadorFacultad?.message} </Typography></span>
...
export default FacultadCoordinador;
