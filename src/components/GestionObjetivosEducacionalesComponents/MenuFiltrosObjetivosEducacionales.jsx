...
const MenuFiltrosObjetivosEducacionales = () => {
    const classes = useStyle();

    return (
        <div className={`container-fluid mx-auto row align-items-center py-2 mb-2 ${classes.card}`}>

            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-10">Codigo</div>
            <div className="col-lg-7 col-md-7 d-none d-sm-none d-md-block d-lg-block">Sumilla</div>
...
export default MenuFiltrosObjetivosEducacionales;